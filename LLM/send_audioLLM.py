...
def send_audio_file_and_reply():
    req = urllib2.Request("http://169.254.49.133:5000/upload", data= , headers=)
        ...
        while True:
            ...
            if word and len(word) >= 2 and word[1] > .3:  
                ...
                #Start recording audio to a file, so we can send it to the LLM.
                    ...
                    time.sleep(1) #Give some time for the NAO to say "listening" and record.
